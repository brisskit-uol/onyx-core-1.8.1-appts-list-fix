...
public abstract class AbstractParticipantReader implements ItemStreamReader<Participant> {
  ...
  public void open(ExecutionContext context) throws ItemStreamException {
    ...
    try {
      ...
      File[] appointmentFiles = getBrisskitInputDirectory().listFiles(this.getFilter());
  ...
  public File getBrisskitInputDirectory() {
    File inDirectory = new File("/var/local/brisskit/onyx/tomcat/webapps/onyx/WEB-INF/appointments/in");
    if(!inDirectory.exists()) {
      log.error("Appointments in directory does not exist: /var/local/brisskit/onyx/tomcat/webapps/onyx/WEB-INF/appointments/in");
    }
    return inDirectory;
  }
